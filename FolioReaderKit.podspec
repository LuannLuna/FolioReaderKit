Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage         = "https://github.com/LuannLuna/FolioReaderKit"
  ...
  s.source           = { :git => "https://github.com/LuannLuna/FolioReaderKit.git", :tag => s.version.to_s }
  ...
  s.dependency 'RealmSwift', '10.39.0'
